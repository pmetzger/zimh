...
SIM = ${COREHD}/scp.c ${COREHD}/scp_breakpoint.c ${COREHD}/scp_context.c ${COREHD}/scp_expect.c ${COREHD}/scp_expr.c ${COREHD}/scp_help_engine.c ${COREHD}/scp_parse.c ${COREHD}/scp_unit.c ${COREHD}/main.c ${RUNTIMEHD}/sim_console.c ${RUNTIMEHD}/sim_fio.c \
