...
| `ssem_doc.doc` | `docs/simulators/SSEM/ssem_doc.md` | yes, proofread | `replaced` | verified against Word; removed fake TOC/page-number artifacts, normalized front matter and small tables, and cleaned minor prose issues while preserving the document's minimalist style where it still read well |
