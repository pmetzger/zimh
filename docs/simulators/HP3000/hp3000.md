...
Additional work on the HP 3000 simulator was done by J. David Bryan.

# Table of Contents

[1 Introduction](#introduction)

[1.1 The HP 3000 Computer System](#the-hp-3000-computer-system)
...
[2.2.3 Memory Addressing](#memory-addressing)

[2.2.3.1 EXAMINE, DEPOSIT, IEXAMINE, and IDEPOSIT](#examine-deposit-iexamine-and-ideposit)

[2.2.3.2 BREAK and NOBREAK](#break-and-nobreak)

[2.2.3.3 RUN and GO](#run-and-go)

[2.2.4 LOAD, DUMP, and BOOT](#load-dump-and-boot)

[2.2.5 POWER FAIL and POWER RESTORE](#power-fail-and-power-restore)

[2.2.6 Device Configuration](#device-configuration)

[2.2.7 Enabling and Disabling Devices](#enabling-and-disabling-devices)

[2.2.8 I/O Interface Assignments](#io-interface-assignments)

[2.2.9 SAVE and RESTORE](#save-and-restore)
...
[2.5 Tracing Simulator Operations](#tracing-simulator-operations)

[3 Processor Device Simulations](#processor-device-simulations)

[3.1 Central Processing Unit](#central-processing-unit)

[3.1.1 System Halt](#system-halt)

[3.1.2 Idling](#idling)

[3.1.3 Simulation Stops](#simulation-stops)

[3.1.4 Tracing](#tracing)

[3.1.5 Registers](#registers)

[3.2 I/O Processor](#io-processor)

[3.3 Selector Channel](#selector-channel)

[3.4 Multiplexer Channel](#multiplexer-channel)

[4 Programmed I/O Device Simulations](#programmed-io-device-simulations)

[4.1 30032B Asynchronous Terminal Controller](#b-asynchronous-terminal-controller)

[4.1.1 Terminal Data Interface](#terminal-data-interface)

[4.1.2 Terminal Control Interface](#terminal-control-interface)

[4.2 30033A Selector Channel Maintenance Board](#a-selector-channel-maintenance-board)

[4.3 30135A System Clock](#a-system-clock)

[5 Selector Channel I/O Device Simulations](#selector-channel-io-device-simulations)

[5.1 30229B Disc Interface with Eight 7905/7906/7920/7925 Drives](#b-disc-interface-with-eight-7905790679207925-drives)

[5.1.1 Device Options](#device-options)

[5.1.2 Unit Options](#unit-options)

[5.1.3 Diagnostic Support](#diagnostic-support)

[5.1.4 BOOT Command](#boot-command)

[5.1.5 Tracing and Registers](#tracing-and-registers)

[6 Multiplexer Channel I/O Device Simulations](#multiplexer-channel-io-device-simulations)

[6.1 30209A Line Printer Controller with One 2607/13/17/18 Line Printer](#a-line-printer-controller-with-one-2607131718-line-printer)

[6.1.1 Device Options](#device-options-1)

[6.1.2 Unit Options](#unit-options-1)

[6.1.3 Vertical Format Unit](#vertical-format-unit)

[6.1.4 Tracing and Registers](#tracing-and-registers-1)

[6.2 30215A Tape Controller with Four 7970B/E Drives](#a-tape-controller-with-four-7970be-drives)

[6.2.1 Device Options](#device-options-2)

[6.2.2 Unit Options](#unit-options-2)

[6.2.3 BOOT Command](#boot-command-1)

[6.2.4 Tracing and Registers](#tracing-and-registers-2)
...
repackaged CX, are essentially subsets of the Series II/III — a smaller
instruction set, limited memory size, and lower-precision floating-point
instructions. Simulation of these machines may be added in the future.
Future simulation of the HP-IB machines (the Series 30 through 70) is
desirable, as the latest MPE versions run only on these machines, but
documentation on the internals of the HP-IB hardware controllers is
nonexistent.
...
Diagnostics suite; see *hp3000_diag.txt* for details.
...
Bank I/O program orders. Absolute accesses always use bank 0. Program,
...
\>\>CPU instr: <u>00</u>.<u>023736</u> <u>000000</u> <u>unimplemented
instruction trap</u>
...
\>\>CPU reg: <u>00</u>.<u>006500</u> <u>000002</u> <u>A 123003, B
001340, X 000000, M i t r o c CCL</u>
...
\>\>IOP irq: <u>Device number 6 acknowledged interrupt request at
priority 14</u>
