...
The IBM 7080 simulator was written by Richard Cornwell.

# Table of Contents

[1. Introduction](#introduction)
[2. Simulator Files](#simulator-files)
[3. IBM 7080 Features](#ibm-7080-features)
[3.1 CPU](#cpu)
[3.2 I/O Channels (CH0..CH6)](#io-channels-ch0..ch6)
[3.3 Unit record devices.](#unit-record-devices.)
[3.3.1 Inquiry Station (INQ)](#inquiry-station-inq)
[3.3.2 711 Card Reader (CDR)](#card-reader-cdr)
[3.3.3 721 Card Punch (CDP)](#card-punch-cdp)
[3.3.4 716 Line Printer (LP)](#line-printer-lp)
[3.4 Magnetic Tape devices](#magnetic-tape-devices)
[3.4.1 729 Magnetic Tape (MTA-D)](#magnetic-tape-mta-d)
[3.4.2 ChronoClock.](#chronoclock.)
[3.5 7908 Devices](#devices)
[3.5.1 1301/1302/2302/7320 Disk devices](#disk-devices)
[3.5.2 Hypertape 7340 Tape drive (HTA)](#hypertape-tape-drive-hta)
[3.5.3 7750 Communications Controller (COM and COML)](#communications-controller-com-and-coml)
...
| Command | Action |
|---|---|
| `BOOT CDR` | loads the first card into memory location 0 and transfers to location 4 |
...
| `SET LPn SINGLE` | sets the printer to single spacing |
| `SET LPn DOUBLE` | sets the printer to double spacing |
| `SET LPn PROGRAM` | sets the printer to programmed spacing |
