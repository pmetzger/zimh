...
[3. IBM 7070 Features](#ibm-7070-features)
[3.1 CPU](#cpu)
[3.2 I/O Channels (CH0..CH8)](#io-channels-ch0..ch8)
[3.3 Unit record devices.](#unit-record-devices.)
[3.3.1 7500 Inquiry Station (INQ)](#inquiry-station-inq)
[3.3.2 7500 Card Reader (CDR)](#card-reader-cdr)
[3.3.3 7550 Card Punch (CDP)](#card-punch-cdp)
[3.3.4 7400 Line Printer (LP)](#line-printer-lp)
...
To compile the IBM 7070, you must define USE_INT64 as part of the
...
i7000_defs.h and changing the number of “NUM_DEVS_xxx” entries. The
entry “NUM_UNITS_xx” determines the number of individual units for each
controller.
