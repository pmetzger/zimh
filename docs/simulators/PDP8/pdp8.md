...
Except for environments that explicitly support it, the FPP8A should
be left disabled.
...
The RF08 supports the `BOOT` command. The default bootstrap is for
...
The DF32 supports the `BOOT` command. The default bootstrap is for
