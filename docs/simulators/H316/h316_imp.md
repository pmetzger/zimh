...
These ARPANET IMP/TIP extensions for the H316 simulator were written by
Robert Armstrong. This work is based on the SIMH H316 simulator package
written by Robert M Supnik.

# Table of Contents

[1 Introduction](#introduction)
[2 Simulator Files](#simulator-files)
[3 Additional Features and Devices](#additional-features-and-devices)
[3.1.1 IMP Pseudo Device](#imp-pseudo-device)
[3.1.2 Real Time Clock](#real-time-clock)
[3.1.3 Watch Dog Timer](#watch-dog-timer)
[3.2 Communications Devices](#communications-devices)
[3.2.1 Modem Interface](#modem-interface)
[3.2.2 Host Interface](#host-interface)
[4 Summary](#summary)
[4.1 Additional Devices](#additional-devices)
[4.2 Modem Interface I/O Instructions](#modem-interface-io-instructions)
[4.3 Host Interface I/O Instructions](#host-interface-io-instructions)
[4.4 Other I/O Instructions](#other-io-instructions)
...
Presently TIP support is not implemented, and IMP host card support is
only partially implemented. The current implementation is sufficient to
allow multiple IMPs to talk via virtual modem connections, and that’s
all.
