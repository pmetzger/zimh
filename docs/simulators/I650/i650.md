...
Use `%SIM_NULL_DEVICE%` for output that should be discarded. It is a
portable simulator variable that expands to the host null device, such
as `/dev/null` on POSIX systems and `NUL:` on Windows.

> sim> carddeck split -10 cdp1 deck1.dck deck2.dck
>
> Put punched cards on deck1.dck, except the last 10 cards that goes to desc2.dck
>
> sim> carddeck split 20 deck1.dck %SIM_NULL_DEVICE% deck1.dck
>
> Removes firsts 20 cards from deck1.dck
>
> sim> carddeck split pat deck1.dck deck1.dck %SIM_NULL_DEVICE%
>
> Discard availability cards from deck1.dck
>
> sim> carddeck split 5cd deck1.dck deck1.dck condensed.dck
>
...
> sim> carddeck join deck1.dck deck2.dck as deck2.dck
>
> Add deck1 at the beginning of deck2.
>
> sim> carddeck join deck1.dck as deck2.dck
>
...
> sim> set debug -n debug.txt create new file debug.txt for …
>
> sim> set cpu debug=cmd;data;detail … CPU debug info
>
> sim> att cdr1 –l deck.dck attach program deck w/ symbolic info
>
> sim> d csw 7019519999 setup load card instruction …
>
> sim> d ar 8000
>
> sim> go … load program into drum
>
> sim> d ar 1000 setup program start address
>
> sim> go run the program
...
>
> sim> do run_it.ini it/it_example_2_src.txt %SIM_NULL_DEVICE% deck_out.dck
