...
struct ROM_File_Descriptor {
   ...
   {"simulators/VAX/ka620.bin", "VAX/vax_ka620_bin.h", 65536,
    0xFF7F930F, "vax_ka620_bin"},
   {"simulators/VAX/ka630.bin", "VAX/vax_ka630_bin.h", 65536,
    0xFF7F73EF, "vax_ka630_bin"},
   {"simulators/VAX/ka610.bin", "VAX/vax_ka610_bin.h", 16384,
    0xFFEF3312, "vax_ka610_bin"},
   {"simulators/VAX/ka410.bin", "VAX/vax_ka410_bin.h", 262144,
    0xFEDA0B61, "vax_ka410_bin"},
   {"simulators/VAX/ka411.bin", "VAX/vax_ka411_bin.h", 262144,
    0xFECB7EE3, "vax_ka411_bin"},
   {"simulators/VAX/ka412.bin", "VAX/vax_ka412_bin.h", 262144,
    0xFED96BB4, "vax_ka412_bin"},
   {"simulators/VAX/ka41a.bin", "VAX/vax_ka41a_bin.h", 262144,
    0xFECBAD2E, "vax_ka41a_bin"},
   {"simulators/VAX/ka41d.bin", "VAX/vax_ka41d_bin.h", 262144,
    0xFECB8513, "vax_ka41d_bin"},
   {"simulators/VAX/ka42a.bin", "VAX/vax_ka42a_bin.h", 262144,
    0xFED8967F, "vax_ka42a_bin"},
   {"simulators/VAX/ka42b.bin", "VAX/vax_ka42b_bin.h", 262144,
    0xFECBB2EF, "vax_ka42b_bin"},
   {"simulators/VAX/ka43a.bin", "VAX/vax_ka43a_bin.h", 262144,
    0xFEAB1DF9, "vax_ka43a_bin"},
   {"simulators/VAX/ka46a.bin", "VAX/vax_ka46a_bin.h", 262144,
    0xFE8D094C, "vax_ka46a_bin"},
   {"simulators/VAX/ka47a.bin", "VAX/vax_ka47a_bin.h", 262144,
    0xFE8D8DDA, "vax_ka47a_bin"},
   {"simulators/VAX/ka48a.bin", "VAX/vax_ka48a_bin.h", 262144,
    0xFEBB854D, "vax_ka48a_bin"},
   {"simulators/VAX/is1000.bin", "VAX/vax_is1000_bin.h", 524288,
    0xFCBCD74A, "vax_is1000_bin"},
   {"simulators/VAX/ka410_xs.bin", "VAX/vax_ka410_xs_bin.h", 32768,
    0xFFD8BD83, "vax_ka410_xs_bin"},
   {"simulators/VAX/ka420_rdrz.bin", "VAX/vax_ka420_rdrz_bin.h", 131072,
    0xFF747E93, "vax_ka420_rdrz_bin"},
   {"simulators/VAX/ka420_rzrz.bin", "VAX/vax_ka420_rzrz_bin.h", 131072,
    0xFF7A9A51, "vax_ka420_rzrz_bin"},
   {"simulators/VAX/ka4xx_4pln.bin", "VAX/vax_ka4xx_4pln_bin.h", 65536,
    0xFF9CD286, "vax_ka4xx_4pln_bin"},
   {"simulators/VAX/ka4xx_8pln.bin", "VAX/vax_ka4xx_8pln_bin.h", 65536,
    0xFFA2FF59, "vax_ka4xx_8pln_bin"},
   {"simulators/VAX/ka4xx_dz.bin", "VAX/vax_ka4xx_dz_bin.h", 32768,
    0xFFD84C02, "vax_ka4xx_dz_bin"},
   {"simulators/VAX/ka4xx_spx.bin", "VAX/vax_ka4xx_spx_bin.h", 131072,
    0xFF765752, "vax_ka4xx_spx_bin"},
   {"simulators/VAX/ka750_new.bin", "VAX/vax_ka750_bin_new.h", 1024,
    0xFFFE7BE5, "vax_ka750_bin_new",
    "From ROM set: E40A9, E41A9, E42A9, E43A9 (Boots: A=DD, B=DB, C=DU"},
   {"simulators/VAX/ka750_old.bin", "VAX/vax_ka750_bin_old.h", 1024,
    0xFFFEBAA5, "vax_ka750_bin_old",
    "From ROM set: 990A9, 948A9, 906A9, 905A9 (Boots: A=DD, B=DM, C=DL, D=DU"},
   {"simulators/VAX/vcb02.bin", "VAX/vax_vcb02_bin.h", 16384,
    0xFFF1D2AD, "vax_vcb02_bin"},
   {"simulators/3B2/roms/3b2_400.bin",
    "simulators/3B2/roms/3b2_400_bin.h", 32768,
    0xFFD55762, "rom_3b2_400"},
   {"simulators/3B2/roms/3b2_700.bin",
    "simulators/3B2/roms/3b2_700_bin.h", 131072,
    0xFFDC0EB8, "rom_3b2_700"},
   {"simulators/VAX/vmb.exe", "VAX/vax_vmb_exe.h", 44544,
    0xFFC014BB, "vax_vmb_exe"},
   {"simulators/PDP11/lunar11/lunar.lda", "PDP11/pdp11_vt_lunar_rom.h",
    13824, 0xFFF15D00, "lunar_lda"},
   {"simulators/PDP11/dazzledart/dazzle.lda",
    "PDP11/pdp11_dazzle_dart_rom.h", 6096, 0xFFF83848, "dazzle_lda"},
   {"simulators/PDP11/11logo/11logo.lda", "PDP11/pdp11_11logo_rom.h",
    26009, 0xFFDD77F7, "logo_lda"},
   {"simulators/swtp6800/swtp6800/swtbugv10.bin",
    "swtp6800/swtp6800/swtp_swtbugv10_bin.h", 1024, 0xFFFE4FBC,
    "swtp_swtbugv10_bin"},
   };
